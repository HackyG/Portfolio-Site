...
document.addEventListener('DOMContentLoaded', () =>{
    ...
    // BG Dot Pulse
    dotPulse.to('.bg-dot', { scale: 1.1, opacity: 0.25, duration: 3, ease: 'linear' });
    dotPulse.to('.bg-dot', { scale: 0.9, opacity: 0.15, duration: 3, yoyo: true, repeat: -1, ease: 'linear' });
    bubblePulse.to('.circle', {scale: 0.9, duration: 2});
    bubblePulse.to('.circle', {scale: 1, duration: 2, yoyo: true, repeat: -1, ease: 'power1.inOut'});
